  ...
  public class CswSearchCriteria
  {
    ...
    public int StartPosition
    {
      ...
      set
      {
        ...
        {
          throw new Exception("startPosition should be a value equal or larger than 0.");
        }
      }
    }
    ...
    public int MaxRecords
    {
      ...
      set
      {
        ...
        {
          throw new Exception("maxRecords should be a value equal or larger than 0.");
        }
      }
    }
    ...
    {
      get {
        return _isLiveDataAndMapOnly;
      }
      set {
        _isLiveDataAndMapOnly = value;
      }
    }
