...
namespace com.esri.gpt.csw
{
  ...
  public class CswCatalog : IComparable
  {
    ...
    /// <summary>
    /// To retrieve information about the CSW service.
    /// </summary>
    /// <remarks>
    /// </remarks>
    ...
    private bool ParseCapabilities(string capabilitiesxml)
    {
      try
      {
        ...
        {
          capabilities = new CswCatalogCapabilities();
        }
    ...
    /// The capabilities details are populated based on the service.
    /// </summary>
    /// <remarks>
    /// </remarks>
    ...
    public bool Connect()
    {
      ...
      string capabilitiesXml = GetCapabilities(URL);
      if (capabilitiesXml != null)
      {
        sb.AppendLine(DateTime.Now + " GetCapabilitiesResponse xml : " + capabilitiesXml);
        ParseCapabilities(capabilitiesXml);
