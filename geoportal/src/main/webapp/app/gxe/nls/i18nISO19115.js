...
define({
  root: {
      documentTypes: {
          data: {
              caption: "ISO 19115 (Data) ML",
              description: ""
          },
          service: {
              caption: "ISO 19119 (Service) ML",
              description: ""
          },
          gmi: {
              caption: "ISO 19115-2 (Imagery and Gridded Data) ML",
              description: ""
          },
      ...
      sections: {
          ...
          metadataConstraints: "Metadata Constraints"
      },
      metadataSection: {
