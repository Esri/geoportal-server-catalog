...
define(["dojo/_base/declare",
        ...
        "dojo/text!./templates/SpatialFilterWithText.html",
...
function(declare, lang, array, aspect, djQuery, on, domConstruct, domClass, domGeometry, domStyle, djNumber, 
    ...
    /*
    A spatial filter with both a map and a text search
...
2019-02-25
  ...
  var oThisClass = declare([SearchComponent], {
    ...
    label: i18n.search.spatialFilter.label,
      labelbbox: i18n.search.spatialFilter.labelForboundingBox,
      locatorParams: null,
    ...
    map: null,
      bBox: new Object() ,
     searchUsingBbox: false,
      searchUsingMap: false,
    ...
    _tmpHandles: null,
      create: function(){
          ...
          if (AppContext.appConfig.searchMap && !!AppContext.appConfig.searchMap.open) {
              this.open = AppContext.appConfig.searchMap.open;
          }
      },
    postCreate: function() {
      ...
      if (this.allowSettings) {
        var link = this.dropPaneMap.addSettingsLink();
      ...
      this.own(aspect.after(this.dropPaneMap,"_setOpenAttr",function() {
    ...
    initializeChoices: function() {
     ...
     // addChoice(i18n.search.spatialFilter.any,"any").checked = true;
      addChoice(i18n.search.spatialFilter.intersects,"intersects").checked = true;
    ...
    initializeMap: function() {
      ...
      this.own(on(map,"Load",lang.hitch(this,function(){
        ...
        this.own(on(map,"ExtentChange",lang.hitch(this,function(){
         // if (this.getRelation() !== "any") this.search();
            if ( this.searchUsingMap) this.search();
        //  this.updateBBox();
        })));
      })));
    },
      ...
      _getBbox: function () {
          ...
          var ymax = parseInt(this.bboxN.value), ymin = parseInt(this.bboxS.value), xmax = parseInt(this.bboxE.value),
              xmin = parseInt(this.bboxW.value);
          this.bBox.xmin = xmin;
          this.bBox.xmax = xmax;
          this.bBox.ymin = ymin;
          this.bBox.ymax = ymax;
    ...
    appendQueryParams: function(params) {
      if ( !(this.searchUsingBbox || this.searchUsingMap) ) return; // no query
...
//        }};
      ...
      if (map && relation !== "any") {
        ...
        var env = null;
        if (!this.searchUsingBbox){
            env = map.geographicExtent;
        } else {
          env = this._getBbox();
