...
function(array, Deferred, util, /*agsUtils, InfoTemplate,*/ PopupTemplate,reactiveUtils) {
  ...
  var _def = {
    ...
    findLayersAdded: function(view,itemId) {
      ...
      array.forEach(view.map.layerIds, function(id) {
        ids.push(id);
      });
      array.forEach(view.map.graphicsLayerIds, function(id) {
        ids.push(id);
      });
      array.forEach(ids, function(id) {
        var lyr = view.map.getLayer(id);
