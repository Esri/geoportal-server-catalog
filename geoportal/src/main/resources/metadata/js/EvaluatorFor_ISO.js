...
G.evaluators.iso = {
  ...
  evalBase: function(task) {
    ...
    G.evalProp(task,item,iden,"url_thumbnail_s","gmd:graphicOverview/gmd:MD_BrowseGraphic/gmd:fileName/gco:CharacterString");
    ...
    /* subject */
    G.evalProps(task,item,root,"apiso_Subject_txt","//gmd:MD_TopicCategoryCode | //gmd:descriptiveKeywords/gmd:MD_Keywords/gmd:keyword/gco:CharacterString");
