...
<xsl:stylesheet version="1.0" 
		...
		-->
				...
				<xsl:element name="ScopeCd">
					<xsl:attribute name="value">
						<xsl:call-template name="MD_ScopeCode">
							<xsl:with-param name="source"><xsl:value-of select="gmd:hierarchyLevel/gmd:MD_ScopeCode/@codeListValue"/></xsl:with-param> 
						</xsl:call-template>
					</xsl:attribute>
				</xsl:element>
			</mdHrLv>
			...
			<mdHrLvName>
				<CharSetCd>
					<xsl:attribute name="value">
						<xsl:call-template name="MD_CharacterSetCode">
							<xsl:with-param name="source"><xsl:value-of select="gmd:characterSet/gmd:MD_CharacterSetCode/@codeListValue"/></xsl:with-param> 
						</xsl:call-template>
					</xsl:attribute>
				</CharSetCd>
			</mdHrLvName>
	...
	<xsl:template name="MD_Identification">
		...
		<!-- idPurp -->
		<idPurp><xsl:value-of select="gmd:purpose/gco:CharacterString"/></idPurp>
	...
	<xsl:template name="MD_DataIdentification">
				...
				<SpatRepTypCd>
					<xsl:attribute name="value">
						<xsl:call-template name="MD_SpatialRepresentationTypeCode">
							<xsl:with-param name="source"><xsl:value-of select="gmd:spatialRepresentationType/@codeListValue"/></xsl:with-param> 
						</xsl:call-template>
					</xsl:attribute>
				</SpatRepTypCd>
			</spatRpType>
		...
		<xsl:for-each select="gmd:characterSet">
			<dataChar>
				<CharSetCd>
					<xsl:attribute name="value">
						<xsl:call-template name="MD_CharacterSetCode">
							<xsl:with-param name="source"><xsl:value-of select="gmd:MD_CharacterSetCode/@codeListValue"/></xsl:with-param> 
						</xsl:call-template>
					</xsl:attribute>
				</CharSetCd>
			</dataChar>
				...
				<TopicCatCd>
					<xsl:attribute name="value">
						<xsl:call-template name="MD_TopicCategoryCode">
							<xsl:with-param name="source"><xsl:value-of select="gmd:MD_TopicCategoryCode" /></xsl:with-param>
						</xsl:call-template>
					</xsl:attribute>
				</TopicCatCd>
			</tpCat>
		...
		<!-- envirDesc -->
		<envirDesc><xsl:value-of select="gmd:environmentDescription/gco:CharacterString"/></envirDesc>
	...
	<xsl:template name="MD_BrowseGraphic">
		<bgFileName><xsl:value-of select="gmd:fileName/gco:CharacterString"/></bgFileName>
		<bgFileType><xsl:value-of select="gmd:fileType/gco:CharacterString"/></bgFileType>
		<bgFileDesc><xsl:value-of select="gmd:fileDescription/gco:CharacterString"/></bgFileDesc>		
	</xsl:template>
	...
	<xsl:template name="MD_RepresentativeFraction">
		<rfDenom><xsl:value-of select="gmd:denominator"/></rfDenom>
	</xsl:template>
	...
	<xsl:template name="MD_Usage">
		<specUsage><xsl:value-of select="gmd:specificUsage/gco:CharacterString"/></specUsage>
		
		<usageDate><xsl:value-of select="gmd:usageDateTime"/></usageDate>
		
		<usrDetLim><xsl:value-of select="gmd:userDetermindLimitations/gco:CharacterString"/></usrDetLim>
...
-->
	...
	<xsl:template name="MD_MaintenanceInformation">
			...
			<MaintFreqCd>
				<xsl:attribute name="value">
					<xsl:call-template name="MD_MaintenanceFrequencyCode">
						<xsl:with-param name="source"><xsl:value-of select="gmd:maintenanceAndUpdateFrequency/gmd:MD_MaintenanceFrequencyCode/@codeListValue"/></xsl:with-param>
					</xsl:call-template>
				</xsl:attribute>
			</MaintFreqCd>
		</maintFreq>
		...
		<!-- dateNext -->
		<dateNext><xsl:value-of select="gmd:dateOfNextUpdate"/></dateNext>
	...
	<xsl:template name="MD_Georectified">
		...
		<chkPtDesc><xsl:value-of select="gmd:checkPointAvailability/gco:Boolean" /></chkPtDesc>
	...
	<xsl:template name="MD_Georeferenceable">
		...
		<ctrlPtAv><xsl:value-of select="gmd:controlPointAvailability/gco:Boolean" /></ctrlPtAv>
		<orieParaAv><xsl:value-of select="gmd:orientationParameterAvailability/gco:Boolean" /></orieParaAv>
		<orieParaDs><xsl:value-of select="gmd:orientationParameterDescription/gco:CharacterString" /></orieParaDs>
		<georefPars><xsl:value-of select="gmd:georeferencedParameters/gco:Record" /></georefPars>
		<xsl:for-each select="gmd:cornerPoints/gml:Point">
			<paraCit>
				<xsl:call-template name="CI_Citation" />
			</paraCit>
	...
	<xsl:template name="MD_Dimension">
		...
		<dimSize><xsl:value-of select="gmd:dimensionSize"/></dimSize>
	...
	<xsl:template name="MD_GeometricObjects">
		...
		<geoObjCnt><xsl:value-of select="gmd:geometricObjectCount"/></geoObjCnt>
	</xsl:template>
	...
	<xsl:template name="MD_Identifier">
		...
		<identCode><xsl:value-of select="gmd:code/gco:CharacterString"/></identCode>
	</xsl:template>
	...
	<xsl:template name="RS_Identifier">
		...
		<identCodeSpace><xsl:value-of select="gmd:codeSpace/gco:CharacterString"/></identCodeSpace>
		<identVrsn><xsl:value-of select="gmd:version/gco:CharacterString"/></identVrsn>
	</xsl:template>
	...
	<xsl:template name="MD_FeatureCatalogueDescription">
		<compCode><xsl:value-of select="gmd:complianceCode" /></compCode>
		
		<xsl:for-each select="gmd:language">
			<catLang><xsl:value-of select="gco:CharacterString" /></catLang>
		</xsl:for-each>
		
		<incWithDS><xsl:value-of select="gmd:includedWithDataset" /></incWithDS>
	...
	<xsl:template name="MD_ImageDescription">
		...
		<illElevAng><xsl:value-of select="gmd:illuminationElevationAngle" /></illElevAng>
		<illAziAng><xsl:value-of select="gmd:illuminationAzimuthAngle" /></illAziAng>
		...
		<cloudCovPer><xsl:value-of select="gmd:cloudCoverPercentage" /></cloudCovPer>
		<prcTypCde><xsl:value-of select="gmd:processingLevelCode" /></prcTypCde>
		<cmpGenQuan><xsl:value-of select="gmd:compressionGenerationQuantity" /></cmpGenQuan>
		<trianInd><xsl:value-of select="gmd:triangulationIndicator" /></trianInd>
		
		<radCalDatAv><xsl:value-of select="gmd:radiometricCalibrationDataAvailability" /></radCalDatAv>
		<camCalInAv><xsl:value-of select="gmd:radiometricCalibrationDataAvailability" /></camCalInAv>
		<filmDistInAv><xsl:value-of select="gmd:filmDistortionInformationAvailability" /></filmDistInAv>
		<lensDistInAv><xsl:value-of select="gmd:lensDistortionInformationAvailability" /></lensDistInAv>
	...
	<xsl:template name="MD_RangeDimension">
		...
		<dimDescrp><xsl:value-of select="gmd:descriptor/gco:CharacterString" /></dimDescrp>
	</xsl:template>
	
	<!-- MD_Band -->
	<xsl:template name="MD_Band">
		<seqID>
			<aName><xsl:value-of select="gmd:sequenceIdentifier/gco:MemberName/gco:aName/gco:CharacterString" /></aName>
			<attributeType>
				<aName><xsl:value-of select="gmd:sequenceIdentifier/gco:MemberName/gco:attributeType/gco:TypeName/gco:aName/gco:CharacterString" /></aName>
			</attributeType>
		</seqID>
		...
		<xsl:if test="count(gmd:maxValue)>0">
			<maxVal><xsl:value-of select="gmd:maxValue"/></maxVal>
		</xsl:if>
		
		<xsl:if test="count(gmd:minValue)>0">
			<minVal><xsl:value-of select="gmd:minValue"/></minVal>
		</xsl:if>
		...
		<xsl:if test="count(gmd:peakResponse)>0">
			<pkResp><xsl:value-of select="gmd:peakResponse" /></pkResp>
		</xsl:if>
		
		<xsl:if test="count(gmd:bitsPerValue)>0">
			<bitsPerVal><xsl:value-of select="gmd:bitsPerValue" /></bitsPerVal>
		</xsl:if>
		
		<xsl:if test="count(gmd:toneGradation)>0">
			<toneGrad><xsl:value-of select="gmd:toneGradation" /></toneGrad>
		</xsl:if>
		
		<xsl:if test="count(gmd:scaleFactor)>0">
			<sclFac><xsl:value-of select="gmd:scaleFactor" /></sclFac>
		</xsl:if>
		
		<xsl:if test="count(gmd:offset)>0">
			<offset><xsl:value-of select="gmd:offset" /></offset>
		</xsl:if>
	</xsl:template>
	...
	<xsl:template name="MD_DigitalTransferOptions">
		<unitsODist><xsl:value-of select="gmd:unitsOfDistribution/gco:CharacterString"/></unitsODist>
		<transSize><xsl:value-of select="gmd:transferSize"/></transSize>
...
-->
	...
	<xsl:template name="MD_Distributor">
		...
		<xsl:for-each select="gmd:distributionFormat/gmd:MD_Format">
			<distorFormat>
				<formatName><xsl:value-of select="gmd:name/gco:CharacterString"/></formatName>
				<formatVer><xsl:value-of select="gmd:version/gco:CharacterString"/></formatVer>
			</distorFormat>
		</xsl:for-each>
		<xsl:for-each select="gmd:transferOptions/gmd:MD_DigitalTransferOptions">
			<distorTran>
	...
	<xsl:template name="MD_Format">
		<formatName><xsl:value-of select="gmd:name/gco:CharacterString"/></formatName>
		<formatVer><xsl:value-of select="gmd:version/gco:CharacterString"/></formatVer>
		<formatAmdNum><xsl:value-of select="gmd:amendmentNumber/gco:CharacterString"/></formatAmdNum>
		<formatSpec><xsl:value-of select="gmd:specification/gco:CharacterString"/></formatSpec>
		<fileDecmTech><xsl:value-of select="gmd:fileDecompressionTechnique/gco:CharacterString"/></fileDecmTech>
	...
	<xsl:template name="MD_Medium">
		<medName>
			<xsl:call-template name="MD_MediumNameCode">
				<xsl:with-param name="source"><xsl:value-of select="gmd:name/gmd:MD_MediumNameCode"/></xsl:with-param>
			</xsl:call-template>
		</medName>
		<xsl:for-each select="gmd:density">
			<medDensity><xsl:value-of select="gmd:density" /></medDensity>
		</xsl:for-each>
		<medDenUnits><xsl:value-of select="gmd:densityUnits/gco:CharacterString" /></medDenUnits>
		<medVol><xsl:value-of select="gmd:volumes" /></medVol>
	...
	<xsl:template name="MD_StandardOrderProcess">
		<resFees units="USD"><xsl:value-of select="gmd:fees/gco:CharacterString" /></resFees>
		<planAvDtTm><xsl:value-of select="gmd:plannedAvailableDateTime/gco:DateTime" /></planAvDtTm>
		<ordInstr><xsl:value-of select="gmd:orderingInstructions/gco:CharacterString" /></ordInstr>
		<ordTurn><xsl:value-of select="gmd:turnaround/gco:CharacterString" /></ordTurn>	
	</xsl:template>
	...
	<xsl:template name="MD_ExtendedElementInformation">
		<!-- extEleName -->
		<extEleName><xsl:value-of select="gmd:name/gco:CharacterString"/></extEleName>
		
		<!-- extShortName -->
		<extShortName><xsl:value-of select="gmd:shortName/gco:CharacterString"/></extShortName>

		<!-- extDomCode -->
		<extDomCode><xsl:value-of select="gmd:domainCode"/></extDomCode>

		<!-- extEleDef -->
		<extEleDef><xsl:value-of select="gmd:definition/gco:CharacterString"/></extEleDef>
		...
		<!-- extEleCond -->
		<extEleCond><xsl:value-of select="gmd:condition/gco:CharacterString"/></extEleCond>
		...
		<!-- extEleMxOc -->
		<extEleMxOc><xsl:value-of select="gmd:maximumOccurrence/gco:CharacterString"/></extEleMxOc>

		<!-- extEleDomVal -->
		<extEleDomVal><xsl:value-of select="gmd:domainValue/gco:CharacterString"/></extEleDomVal>
		...
		<!-- extEleRule -->
		<extEleRule><xsl:value-of select="gmd:rule/gco:CharacterString"/></extEleRule>
	...
	<xsl:template name="MD_ApplicationSchemaInformation">
		...
		<!-- asSchLang -->
		<asSchLang><xsl:value-of select="gmd:schemaLanguage/gco:CharacterString"/></asSchLang>
		
		<!-- asCstLang -->
		<asCstLang><xsl:value-of select="gmd:constraintLanguage/gco:CharacterString"/></asCstLang>
		
		<!-- asAscii -->
		<asAscii><xsl:value-of select="gmd:schemaAscii/gco:CharacterString"/></asAscii>

		<!-- asGraFile -->
		<asGraFile><xsl:value-of select="gmd:graphicsFile/gco:Binary/@src"/></asGraFile>

		<!-- asSwDevFile -->
		<asSwDevFile><xsl:value-of select="gmd:softwareDevelopmentFile/gco:Binary/@src"/></asSwDevFile>

		<!-- asSwDevFiFt -->
		<asSwDevFiFt><xsl:value-of select="gmd:softwareDevelopmentFileFormat/gco:CharacterString"/></asSwDevFiFt>
	</xsl:template>
	...
	<xsl:template name="EX_Extent">
		<exDesc><xsl:value-of select="gmd:EX_Extent/gco:CharacterString"/></exDesc>
	...
	<xsl:template name="EX_GeographicBoundingBox">
		...
		<northBL><xsl:value-of select="gmd:northBoundLongitude/gco:Decimal" /></northBL>
		<southBL><xsl:value-of select="gmd:southBoundLongitude/gco:Decimal" /></southBL>
	</xsl:template>
	...
	<xsl:template name="EX_VerticalExtent">
		<vertEle>
			<vertMinVal><xsl:value-of select="gmd:minimumValue" /></vertMinVal>
			<vertMaxVal><xsl:value-of select="gmd:maximumValue" /></vertMaxVal>
			<vertCRS><xsl:value-of select="gmd:verticalCRS" /></vertCRS>
		</vertEle>
	</xsl:template>
	...
	<xsl:template name="CI_Citation">
		...
		<collTitle><xsl:value-of select="gmd:collectiveTitle/gco:CharacterString" /></collTitle>

		<resAltTitle><xsl:value-of select="gmd:alternateTitle/gco:CharacterString"/></resAltTitle>
		...
		<isbn><xsl:value-of select="gmd:ISBN/gco:CharacterString"/></isbn>
		<issn><xsl:value-of select="gmd:ISSN/gco:CharacterString"/></issn>
	...
	<xsl:template name="CI_ResponsibleParty">
		...
		<rpIndName><xsl:value-of select="gmd:individualName/gco:CharacterString"/></rpIndName>
		<rpOrgName><xsl:value-of select="gmd:organisationName/gco:CharacterString"/></rpOrgName>
		<rpPosName><xsl:value-of select="gmd:positionName/gco:CharacterString"/></rpPosName>
	...
	<xsl:template name="CI_Address">
		<cntAddress addressType="">
			...
			<adminArea><xsl:value-of select="gmd:administrativeArea/gco:CharacterString"/></adminArea>
			<postCode><xsl:value-of select="gmd:postalCode/gco:CharacterString"/></postCode>
	...
	<xsl:template name="CI_Contact">
		...
		<cntHours><xsl:value-of select="gmd:hoursOfService/gco:CharacterString"/></cntHours>
		<cntInstr><xsl:value-of select="gmd:contactInstructions/gco:CharacterString"/></cntInstr>
	</xsl:template>
...
-->
	...
	<xsl:template name="CI_OnlineResource">
		<linkage><xsl:value-of select="gmd:linkage/gmd:URL"/></linkage>
		<protocol><xsl:value-of select="gmd:protocol/gco:CharacterString"/></protocol>
		<appProfile><xsl:value-of select="gmd:applicationProfile/gco:CharacterString"/></appProfile>
		<orName><xsl:value-of select="gmd:name/gco:CharacterString"/></orName>
		<orDesc><xsl:value-of select="gmd:description/gco:CharacterString"/></orDesc>
		<orFunct>
			<OnFunctCd>
				<xsl:attribute name="value">
	...
	<xsl:template name="CI_Series">
		<seriesName><xsl:value-of select="gmd:name/gco:CharacterString"/></seriesName>
		<issId><xsl:value-of select="gmd:issueIdentification/gco:CharacterString"/></issId>
		<page><xsl:value-of select="gmd:page/gco:CharacterString"/></page>
	</xsl:template>
	...
	<xsl:template name="CI_Telephone">
		<cntPhone>
			<voiceNum tddtty=""><xsl:value-of select="gmd:voice/gco:CharacterString"/></voiceNum>
			<faxNum><xsl:value-of select="gmd:facsimile/gco:CharacterString"/></faxNum>
		</cntPhone>
	</xsl:template>
