...
public class Cql2JsonToOpenSearchConverter { 
  ...
  private Map<String, Object> visitOpNode(Object nodeObj) { 
    ...
    switch (op) { 
      ...
      case "between": { 
        ...
        // allow dates or numbers 
        rangeComp.put("gte", isIsoInstant(low) ? String.valueOf(low) : toNumber(low)); 
        rangeComp.put("lte", isIsoInstant(high) ? String.valueOf(high) : toNumber(high)); 
  ...
  private Object extractValueFromArg(Object arg) { 
    ...
    if (arg instanceof Map) { 
      ...
      // NEW: explicit timestamp support
      if (m.containsKey("timestamp")) return m.get("timestamp"); 
  ...
  private Map<String,Object> visitComparison(Map<String,Object> node) { 
    ...
    switch (op) { 
      ...
      case ">": return rangeQuery(field, "gt",  isIsoInstant(value) ? String.valueOf(value) : toNumber(value)); 
      case "<": return rangeQuery(field, "lt",  isIsoInstant(value) ? String.valueOf(value) : toNumber(value)); 
      case ">=": return rangeQuery(field, "gte", isIsoInstant(value) ? String.valueOf(value) : toNumber(value)); 
      case "<=": return rangeQuery(field, "lte", isIsoInstant(value) ? String.valueOf(value) : toNumber(value)); 
  ...
  // NEW: datetime detection (ISO-8601) supporting 'Z' or offset
  ...
  public static void main(String[] args) throws Exception { 
    ...
    String json1 = "{\"filter\":{\"op\":\"and\",\"args\":[{\"op\":\"=\",\"args\":[{\"property\":\"xom_source_system_s\"},\"Marten\"]},{\"op\":\"=\",\"args\":[{\"property\":\"xom_edp_equip_id_s\"},\"test-point1-geom\"]},{\"op\":\">=\",\"args\":[{\"property\":\"datetime\"},{\"timestamp\":\"2021-04-08T04:39:23Z\"}]}]}}"; 
