define(["dojo/_base/declare",
        ...
        "dojo/text!./templates/MI_OperationTypeCode.html",
        "../../../../../../kernel"],
function(declare, lang, has, Descriptor, InputSelectOne, Options, Option, CodeListAttribute, CodeListValueAttribute,
  ...
  if(has("extend-esri")) {
    lang.setObject("dijit.metadata.types.iso.gmi.acquisitionInformation.MI_OperationTypeCode", oThisClass, esriNS);
  }
