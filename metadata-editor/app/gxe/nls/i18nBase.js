define({
  root: ({
    ...
    editor: {
      ...
      xmlViewOnly: "The type of metadata associated with this item is not supported by the editor. Metadata must be in the ArcGIS format.",
      editorDialog: {
        caption: "Metadata",
      ...
      load: {
        caption: "Open",
        dialogTitle: "Open",
        typeTab: "New Document",
        fileTab: "Open File",
        templateTab: "A Template",
        itemTab: "Your Item",
        filePrompt: "Select a local ArcGIS Metadata XML file. Metadata must be in ArcGIS format.",
        templatePrompt: "Create Metadata",
        pullItem: "Populate metadata with item details.",
        importWarning: "The selected file does not appear in ArcGIS format. Uploaded metadata must be in ArcGIS format.",
        loading: "Loading...",
      ...
      saveDraft: {
        ...
        dialogTitle: "Save Local Copy"
      },
      validate: {
        caption: "Validate",
        dialogTitle: "Validation",
        docIsValid: "Your document is valid."
      },
      del: {
        caption: "Delete",
    ...
    optionalNode: {
      switchTip: "Include or exclude this section."
    },
    ...
    validationPane: {
      ...
      prompt: "(click on each message below and provide the required information in the field specified)"
    }
